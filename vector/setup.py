...
extensions = [Extension("gamera.toolkits.vector.vectorcore",
                        ["src/vectorcore.cpp",
                         "src/floatpointobject.cpp",
                         "src/transformationobject.cpp",
                         "src/segmentobject.cpp",
                         "src/pathobject.cpp",
                         "src/pathlistobject.cpp"],
                        include_dirs=["include"] + gamera_setup.get_gamera_include_dirs())]
...
setup(name=TOOLKIT_NAME, version="alphamatic",
